...
CREATE TABLE `reptiles` (
  ...
  PRIMARY KEY (`id`),
  KEY `nombrw_idx` (`nombre`),
  CONSTRAINT `nombrw` FOREIGN KEY (`nombre`) REFERENCES `animales` (`nombre`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `reptiles` VALUES (1,'Python',13,'Negro','Tierra'),(2,'Python',10,'Rojo','Tierra'),(3,'Tortuga Caiman',60,'Cafe','Ambos'),(4,'Cobra',10,'Cafe','Tierra');
