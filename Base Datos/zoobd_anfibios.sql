...
CREATE TABLE `anfibios` (
  ...
  `piel` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `nombre_idx` (`nombre`),
  CONSTRAINT `anfibios_ibfk_1` FOREIGN KEY (`nombre`) REFERENCES `animales` (`nombre`)
...
INSERT INTO `anfibios` VALUES (1,'Rana dardo venenoso',2,'Morado','Babosa'),(2,'Rana toro',4,'Cafe','Babosa'),(3,'Rana toro',10,'Beige','Babosa');
