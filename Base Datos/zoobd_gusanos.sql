...
CREATE TABLE `gusanos` (
  ...
  PRIMARY KEY (`id`),
  KEY `nombre` (`nombre`),
  CONSTRAINT `gusanos_ibfk_1` FOREIGN KEY (`nombre`) REFERENCES `animales` (`nombre`)
...
INSERT INTO `gusanos` VALUES (1,'Esocaeka',10,'Negro','Mar'),(2,'Tebo',1,'Amarillo','Normal'),(3,'Tebo',1,'Naranjo','Nematodo'),(4,'Tebo',100,' Verde','Anelido');
