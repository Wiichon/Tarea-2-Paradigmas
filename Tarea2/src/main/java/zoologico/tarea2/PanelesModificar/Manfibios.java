 ...
 * @author Wilson
 */
public class Manfibios extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Tipo de piel");

        datoEspecial.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Babosa", "Normal" }));
