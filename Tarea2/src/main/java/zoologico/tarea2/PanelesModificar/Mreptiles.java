 ...
 * @author Wilson
 */
public class Mreptiles extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Tipo de reptil");

        datoEspecial.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tierra", "Mar", "Ambos" }));
